    ...
    protected class SpeechRecognitionListener implements RecognitionListener {
        ...
        //    Log.i("spech", "onPartialResults");
            ...
            if (Currentdata == null) {
                ...
                LogodosiaActivity.textET.setText("" + word);
            } else {
                LogodosiaActivity.textET.setText(Currentdata + " " + word);
                LogodosiaActivity.textET.setSelection(LogodosiaActivity.textET.getText().length());
            }

            newcurrent = LogodosiaActivity.textET.getText().toString();
            identify = 1;
           // Log.d("partail", "" + word);
        }
        ...
        public void onResults(Bundle results) {
            ...
            if (result == 0) {
                LogodosiaActivity.textET.setText(word);
                Currentdata = LogodosiaActivity.textET.getText().toString();
            } else if (result == 1) {
                if (Currentdata != null) {
                    LogodosiaActivity.textET.setText(Currentdata + "\n" + word);
                    LogodosiaActivity.textET.setSelection(LogodosiaActivity.textET.getText().length());
                }
            }
            Currentdata = LogodosiaActivity.textET.getText().toString();
