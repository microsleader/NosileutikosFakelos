...
public class TableTest implements AsyncCompleteTask2, AsyncGetUpdate_JSON, MyDialogFragmentMedicineCloseListener, AsyncGetDelete , DataSended_str {
    ...
    public TableTest(TableLayout ll, Toolbar t, View view, Bundle bundle, DialogFragment dialogFragment) {
    ...
    public TableTest(TableLayout ll, Toolbar t,  Intent in  , Activity act) {
